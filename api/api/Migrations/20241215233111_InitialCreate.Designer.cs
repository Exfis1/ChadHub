...
namespace api.Migrations
{
    ...
    [Migration("20241215233111_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("api.Auth.Model.ForumUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("varchar(255)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("api.Auth.Model.ForumUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("api.Data.Entities.Comment", b =>
                {
                    ...
                    b.HasOne("api.Auth.Model.ForumUser", "User")
                        .WithMany("Comments")
                        .HasForeignKey("UserId")
